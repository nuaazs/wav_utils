...
parser.add_argument('--data_path', type=str, default='/ssd2/cti_aftervad_train_data', help='长江时代数据集路径')
parser.add_argument('--save_path', type=str, default='/ssd2/cti_aftervad_train_data_vad', help='保存路径')
