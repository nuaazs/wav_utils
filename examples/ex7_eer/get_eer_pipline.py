...
parser.add_argument('--total_worker', type=int, default=20,help='')
parser.add_argument('--worker_idx', type=int, default=1,help='')
...
if __name__ == "__main__":
    ...
    # load wavs pairs in this worker
    ...
    for wav1, wav2 in tqdm(wav_pairs):
        ...
        if "paddle" in cfg.NAME:
            ...
            score = similarity(torch.Tensor(embedding1),torch.Tensor(embedding2)).numpy()[0][0]#.detach().cpu()
        else:
